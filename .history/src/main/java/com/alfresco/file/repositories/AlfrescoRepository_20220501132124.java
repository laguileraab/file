...
import com.alfresco.file.utils.MyAuthenticator;
...
public class AlfrescoRepository {
  ...
  public StreamingResponseBody downloadFile(String id) throws IOException, InterruptedException {
    ...
    StreamingResponseBody stream = out -> {
      ...
      //Basic authentication for download file
      MyAuthenticator.setPasswordAuthentication(Constants.USERALFRESCO, Constants.PASSALFRESCO);
