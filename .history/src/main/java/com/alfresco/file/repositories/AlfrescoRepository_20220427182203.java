...
public class AlfrescoRepository {
    ...
    public Mono<Object> searchFile(String id) {
        ...
        RequestHeadersSpec<?> bodySpec = uriSpec
                ...
                .uri(URI.create(base + path + api + tenant + visibility + repo + versions + node));
        ...
        Mono<Object> response = bodySpec.exchangeToMono(responseL -> {
          ...
          entry entry = mapper.convertValue(object, entry.class);
