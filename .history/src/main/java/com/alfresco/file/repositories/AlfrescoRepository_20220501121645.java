...
public class AlfrescoRepository {
  ...
  public FileDownload downloadFile(String id) throws IOException, InterruptedException {
    ...
    FileOutputStream fileOutputStream = new FileOutputStream(node.getEntry().getName());
