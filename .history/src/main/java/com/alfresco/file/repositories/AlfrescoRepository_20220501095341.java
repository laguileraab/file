...
public class AlfrescoRepository {
  ...
  public EntryDownload downloadFile(String id) throws IOException, MalformedURLException {
    WebClient webClient = WebClient.builder()
        .baseUrl(Constants.alfrescoBase)
        .defaultHeaders((header) -> {
          header.add(HttpHeaders.AUTHORIZATION, basicAuthHeader);
  ...
  public String downloadFileURL(String id) throws IOException, MalformedURLException {
    WebClient webClient = WebClient.builder()
        .baseUrl(Constants.alfrescoBase)
        .defaultHeaders((header) -> {
          header.add(HttpHeaders.AUTHORIZATION, basicAuthHeader);
    ...
    return URL + entry.getEntry().getId();
  }
