...
public class AlfrescoRepository {
  ...
  public Node getNode() {
    ...
    URI url = URI.create(Constants.URL + Constants.NODE + Constants.NODEIDBYDEFAULT);
  ...
  public FileDownload downloadFile(String id) throws IOException, MalformedURLException {
    ...
    FileOutputStream fileOutputStream = new FileOutputStream(entry.getEntry())) {
  ...
  public String downloadFileURL(String id){
    ...
    return Constants.URL + entry.getEntry().getId() + "content";
  }
