...
public class FileController {
    ...
    @GetMapping
    public ResponseEntity<ByteArrayResource> getNode() throws MalformedURLException, IOException {
        Node fileUpload = fileService.getNode();
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + fileUpload.getFilename() + "\"")
                .body(new ByteArrayResource(node));
    }
