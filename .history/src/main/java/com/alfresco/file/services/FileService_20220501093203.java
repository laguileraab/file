...
public class FileService {
    ...
    public EntryDownload downloadFile(String id) throws MalformedURLException, IOException{

        return alfresco.downloadFile(id);
        
    }

    public EntryDownload downloadFileURL(String id) throws MalformedURLException, IOException{
